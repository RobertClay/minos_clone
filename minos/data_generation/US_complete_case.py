...
if __name__ == "__main__":
    ...
    complete_case_vars = ["housing_quality", 'job_sector', 'marital_status', 'yearly_energy', "job_sec",
    ...
    # now make sure its int not float (need to convert NA to 2 for this to work - 2 is most common value)
    ...
    data['neighbourhood_safety'] = pd.to_numeric(data['neighbourhood_safety'], errors='coerce').fillna(1).astype('int')
